...
import logo from '../img/foodiegram.png';
const AppHeader = ({ authenticated, onLogout }) => {
  return (
    <>
      <header aria-label="Page Header" className="bg-blk">
        <div className="mx-auto max-w-screen-xl px-4  sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div>
              <h6 className="text-xl font-bold text-white "> Drop Your Thoughts Here Foodies!!!</h6>
            </div>
